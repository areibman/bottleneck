...
export function MultiFileDiffViewer({
  ...
  const { diffView, showWhitespace, wordWrap, theme } = useUIStore();
    ...
    >
      <div className="space-y-4 p-4">
        {filesWithContent.map((fileWithContent) => {
          ...
          const originalToShow =
            isShowingFull && fileWithContent.originalContent !== undefined
              ? fileWithContent.originalContent
              : fileWithContent.patchOriginalContent;
          const modifiedToShow =
            isShowingFull && fileWithContent.modifiedContent !== undefined
              ? fileWithContent.modifiedContent
