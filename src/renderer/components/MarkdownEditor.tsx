...
import { Eye, Edit, Maximize2, Minimize2, Bold, Italic, Link, Code, List, ListOrdered, Quote, Heading } from 'lucide-react';
        ...
        <button
          ...
          className={cn(
            ...
            theme === 'dark'
              ? "hover:bg-gray-700 text-gray-400 hover:text-gray-200"
              : "hover:bg-gray-200 text-gray-600 hover:text-gray-800",
            showPreview && (theme === 'dark' ? "bg-gray-700 text-gray-200" : "bg-gray-200 text-gray-800")
          )}
...
export const MarkdownEditor = memo(function MarkdownEditor({
  ...
  const handleItalic = useCallback(() => insertMarkdown('*', '*'), [insertMarkdown]);
  const handleCode = useCallback(() => insertMarkdown('`', '`'), [insertMarkdown]);
    ...
    <div className={cn(
      ...
      <div className={cn(
        ...
        {showPreview ? (
          <div className={cn(
            "p-4 overflow-auto",
            isFullscreen ? "h-full" : `min-h-[${minHeight}] max-h-[${maxHeight}]`
      ...
      {!showPreview && (
        <div className={cn(
          ...
          <span>Markdown supported • Drag & drop images • Cmd+B for bold, Cmd+I for italic</span>
        </div>
      )}
    </div>
  );
